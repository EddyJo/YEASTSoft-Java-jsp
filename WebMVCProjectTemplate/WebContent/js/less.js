...
tree.functions = {
    ...
    "svg-gradient": function(direction) {
        ...
        if (useBase64) {
            try {
                returner = require('./encoder').encodeBase64(returner); // TO DO browser implementation
            } catch(e) {
                useBase64 = false;
            }
        }
...
tree.Comment.prototype = {
    ...
    genCSS: function (env, output) {
        ...
        output.add(this.value.trim()); //TO DO shouldn't need to trim, we shouldn't grab the \n
    },
    toCSS: tree.toCSS,
...
tree.Extend.prototype = {
    ...
    findSelfSelectors: function (selectors) {
        ...
        for(i = 0; i < selectors.length; i++) {
            ...
            // future TO DO - move both logics into the selector joiner visitor
...
tree.Selector.prototype = {
    ...
    genCSS: function (env, output) {
        ...
        if (!this._css) {
            //TO DO caching? speed comparison?
...
function createCSS(styles, sheet, lastModified) {
    ...
    if (lastModified && cache) {
        ...
        try {
            ...
            //TO DO - could do with adding more robust error handling
...
function loadStyleSheet(sheet, callback, reload, remaining, modifyVars) {
    ...
    loadFile(sheet.href, null, function(e, data, path, newFileInfo, webInfo) {
        ...
        //TO DO add tests around how this behaves when reloading
        removeError(path);
