...
<div class="container">
	...
	<a href="<c:url value='/forward.do?url=/chart/genderchart.jsp'/>" class="btn btn-dark btn-lg">성별 약품 TOP 10</a>
...
<!-- Chart code -->
<h1>
	<c:if test="${!empty medTopData}">
		<c:if test="${medTopData eq '[]' }">데이터가 없습니다</c:if>
	</c:if>
</h1>
