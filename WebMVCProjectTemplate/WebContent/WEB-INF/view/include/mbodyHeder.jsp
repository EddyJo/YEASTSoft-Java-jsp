			...
			<div class="navbar navbar-wp navbar-arrow mega-nav" role="navigation">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown"><a
							href="<c:url value='/forward.do?url=/menu/intro.jsp'/>"
							class="dropdown-toggle">소개(기능 및 조직구성) <!--<fmt:message key="DASHBOARD" />-->
						</a> </ul--></li>
						<li class="dropdown"><a href='<c:url value="/"/>'
							class="dropdown-toggle" data-toggle="dropdown">검색이력<fmt:message
									key="BOARD" /></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value='/searchId.do'/>">나의 검색이력 조회
						...
						<li class="dropdown"><a href='<c:url value="/"/>'
							class="dropdown-toggle" data-toggle="dropdown">(메뉴5)<fmt:message
									key="MEMBER" /></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value='/insertmedinfo.do'/>">약품
										DB추가<fmt:message key="MY_INFO" />
								</a>
								<li><a href="<c:url value='/insertFoodInfo.do'/>">식품
										DB추가<fmt:message key="UPDATE_USER_INFO" />
								</a>
								<li><a href="<c:url value='/'/>">(메뉴5-3)<fmt:message
											key="EXIT_MEMBER" /></a>
								<li><a href="<c:url value='/'/>">(메뉴5-4)<fmt:message
											key="SIGN_OUT" /></a>
							</ul></li>
